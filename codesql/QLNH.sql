...
-- Xóa các bảng nếu đã tồn tại để tránh lỗi khi chạy lại
...
-- Bảng KhachHang
INSERT INTO KhachHang (maKH, tenKH, email, sdt, cccd, loaiKH) VALUES 
('KH0001', N'Nguyễn Văn A', 'a@gmail.com', '0912345678', '045205001632', N'Khách thường'),
('KH0002', N'Trần Thị B', 'b@gmail.com', '0923456789', '045205001621', N'Thành viên'),
('KH0003', N'Lê Văn C', 'c@gmail.com', '0934567890', '045205001676', N'Thành viên');
...
-- Bảng PhieuDatBan (FIXED: Sửa lỗi thứ tự cột và dữ liệu trùng lặp)
