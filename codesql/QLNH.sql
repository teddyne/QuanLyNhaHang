...
CREATE TABLE KhuyenMai (
    ...
    CONSTRAINT FK_KM_Mon1 FOREIGN KEY (mon1) REFERENCES MonAn(maMon),
    CONSTRAINT FK_KM_Mon2 FOREIGN KEY (mon2) REFERENCES MonAn(maMon),
    CONSTRAINT FK_KM_MonTang FOREIGN KEY (monTang) REFERENCES MonAn(maMon)
);
...
('KM0001', N'Giảm 10% toàn menu', 'L01', 10, '2025-01-01', '2025-06-30', N'Đã hết hạn', N'Tất cả', 0, NULL, NULL, NULL, NULL),
('KM0002', N'Giảm 50k đơn từ 500k', 'L02', 50000, '2025-07-01', '2025-12-31', N'Đang áp dụng', N'Tất cả', 500000, NULL, NULL, NULL, NULL),
('KM0003', N'Mua 1 lẩu hải sản + 1 tôm chiên xù tặng 1 sữa chua mít', 'L03', 0, '2025-10-01', '2025-12-31', N'Đang áp dụng', N'Tất cả', 0, 'MON0001', 'MON0005', 'MON0018', N'Tặng món tráng miệng'),
('KM0004', N'Giảm 10% cho thành viên', 'L01', 10, '2025-10-01', '2025-12-31', N'Đang áp dụng', N'Thành viên', 1000000, NULL, NULL, NULL, NULL),
('KM0005', N'Mua 1 gà chiên mắm + 1 phở bò tặng 1 Coca', 'L03', 0, '2025-10-15', '2025-12-31', N'Đang áp dụng', N'Tất cả', 0, 'MON0004', 'MON0009', 'MON0035', N'Tặng 1 lon Coca khi mua combo');
...
('HD0001', '2025-10-27 19:00', N'Đã thanh toán', 'P0001', 'KH0001', 'KM0003', 'NV0002', 0, N'Áp dụng KM tặng sữa chua mít'),
('HD0002', '2025-10-27 19:30', N'Đã thanh toán', 'P0002', 'KH0002', 'KM0001', 'NV0003', 0, N'Giảm 10% tổng hóa đơn'),
('HD0003', '2025-10-28 12:30', N'Đã thanh toán', 'P0003', 'KH0003', 'KM0005', 'NV0004', 0, N'Tặng Coca khi mua combo gà chiên + phở bò'),
('HD0004', '2025-10-28 13:00', N'Đã thanh toán', 'P0004', 'KH0001', NULL, 'NV0001', 0, N'Không áp dụng KM'),
('HD0005', '2025-10-29 18:30', N'Đã thanh toán', 'P0005', 'KH0002', 'KM0004', 'NV0003', 0, N'Giảm 10% cho thành viên');
...
('HD0001', 'MON0018', 1, 38000, N'Tặng sữa chua mít theo KM');
INSERT INTO ChiTietHoaDon (maHD, maMon, soLuong, donGia, ghiChu) VALUES
...
('HD0003', 'MON0035', 1, 25000, N'Tặng Coca theo KM');
